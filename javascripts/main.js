...
$(document).ready(function($)
{
    ...
    if (ie8up())
    {
        ...
        $('#to-input-2').val($('#company-street-address-2').html());
    }
    else{
    ...
    if (ie8up() && includeMap)
        {
            var googleMap = function(mapOptions)
            {
                ...
                var myOptions = {
                    ...
                    mapTypeControl:false,
                    navigationControl:false,
                    companyAddress: 'Tavagnacco, Udine, Italy',
                    mapId:"map-2"
                };
            ...
            thisMap = googleMap({companyAddress:companyAddress2});
            ...
            var googleDirections = {
                ...
                dirContainer: document.getElementById('dir-container'),
                fromInput: document.getElementById('from-input'),
                toInput: document.getElementById('to-input-2'),
                travelModeInput: document.getElementById('travel-mode-input'),
                unitInput: document.getElementById('unit-input'),
...
(function(f){function u(a,b){var c=this,h=a.add(c),e,i=0,j=0,m=a.attr("title"),q=a.attr("data-tooltip"),r=n[b.effect],l,s=
